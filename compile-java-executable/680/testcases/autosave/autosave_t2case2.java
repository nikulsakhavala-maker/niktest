...
public class t2case2 {
	...
	public void t2case2() {
		tg.openBrowser();
		tg.wait("ele_searchforp943", ComparisonType.IS_VISIBLE);
		tg.click("ele_searchforp943", 1);
		tg.wait("ele_searchforp943", ComparisonType.IS_VISIBLE);
		tg.type("ele_searchforp943", "shoes");
		tg.wait("ele_shoesforme629", ComparisonType.IS_VISIBLE);
		tg.click("ele_shoesforme629", 1);
		tg.wait("ele_imgtgwebco190", ComparisonType.IS_VISIBLE);
